...
class GluePromptOpt:
    ...
    def __init__(self,
        ...
        self.prompt_opt = prompt_opt_cls(dataset, base_path, self.setup_config,
                                         self.prompt_pool, self.data_processor, self.logger)

    def get_best_prompt(self,sample, prompt_level) -> (str, Any):
        """
        ...
        self.BEST_PROMPT = self.prompt_opt.get_best_prompt(self.prompt_opt_param,prompt_level=prompt_level, sample=sample)
