...
if __name__ == '__main__':
    ...
    output_format = "The final answer must be one of the following two: negative,positive." \
    ...
    print(base_dir)
    data_samples = stream_jsonl("data/sst2_test.jsonl")
    ...
    file_path = os.path.join(base_dir, 'data', 'sst2_train.jsonl')
    ...
    for index, sample in tqdm(enumerate(list(data_samples)), desc="Processing Samples"):
        ...
        for prompt_level in range(1,6):
            gp.prompt_opt_param.base_instruction = "Classify the sentiment of the given text into one of the two categories: negative, positive."
            ...
            if is_correct:
                correct_count += 1
                write_results("sst2",sample, index,best_prompt, reasoning_content, answer_content, predicted_answer,
                ...
                if prompt_level < 5:
                    ...
                    write_results("sst2",sample, index,best_prompt, reasoning_content, answer_content,
